        ...
        $(document).ready(function(){
            ...
            $('#Login').submit(function(e){
                ...
                // Handle login logic here
                    if(email === '' || password === '') {
                        $('#feedback').html("<p class='text-danger'>All fields are required</p>");
                        e.preventDefault();
                    }
            })
            ...
            $('#user_password').change(function(){
                ...
                $.ajax({
                    ...
                    success: function(res){
                      var toWrite = "<span style='color:green;'>" + res + "</span>";
                      $('#feedback').html(toWrite);
                    },
                    error: function(er){
                        console.log(er);
                    },
                    ...
                    complete: function(){
                        $('#loader').empty();
                        $('#click').addClass('btn btn-success').removeClass('btn-secondary').attr('disable').a;
                    }
                })
            });
