                ...
                <div class="row mt-4 mb-4">
                    <div class="col-12 d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <p class="text-muted mb-0" style="font-size: 0.9em;">Fill in the details below to list your property on NaijaRent</p>
                        </div>
                       <div>
                        ...
                        <a href="confirm_payment.php?property_id=<?php echo $property_id; ?>" class="btn btn-danger px-4">
                            <i class="fa-solid fa-cash me-2"></i> Promote This Listing
                        </a>
                       </div>
                    </div>
                </div>
                                        ...
                                        <div class="card border-0 shadow-sm p-4 mb-4">
                                            ...
                                            <div class="row g-3">
                                                <div class="col-12">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="e.g. Spacious 3-bedroom flat in Lekki Phase 1" name="title" id='title' value="<?php echo $res['title'] ?>">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="number" class="form-control"  name="price" id='price' value="<?php echo $res['price'] ?>">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="number" class="form-control text-center fw-medium"
                                                            id="bedrooms" value="<?php echo $res['bedrooms'] ?>" min="0" max="20" name="bedrooms">
                                                        <button class="btn btn-outline-secondary" type="button">+</button>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="input-group">
                                                        <button class="btn btn-outline-secondary" type="button">−</button>
                                                        <input type="number" class="form-control text-center fw-medium"
                                                            id="bathrooms" value="<?php echo $res['bathrooms'] ?>" min="0" max="20" name="bathrooms">
                                                        <button class="btn btn-outline-secondary" type="button">+</button>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="input-group">
                                                        <button class="btn btn-outline-secondary" type="button">−</button>
                                                        <input type="number" class="form-control text-center fw-medium"
                                                            id="toilets" value="<?php echo $res['toilet'] ?>" min="0" max="20" name="toilets">
                                                        <button class="btn btn-outline-secondary" type="button">+</button>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-12">
                                        <div class="card border-0 shadow-sm p-4 mb-4">
                                            ...
                                            <div class="d-flex justify-content-between">
                                                ...
                                                <button class="btn btn-success px-5 py-2" name="update" type="submit" value="submit">
